...
*/	
	...
	UIBarButtonItem *doneNavButton = [[[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"Done", @"")        
...
- (void) BackButtonPressed
{
    ...
    if (![strAllValues isEqualToString:@""])
    {
		UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"" 
			message:@"Are you sure ?\n\n(You've given answers, which will be lost, press Done for results!)" 
